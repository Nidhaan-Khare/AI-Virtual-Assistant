...
function Home() {
  ...
  const [listening,setListening]=useState(false);// sunn raha hai ya nahi
  const isSpeakingRef=useRef(false); // bol raha hai ya nahi
  const recognitionRef=useRef(null); // recognition kya hai. Jo recognition start karenge wo daal denge iske andar.
...
useEffect(()=>{
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#02023d] flex justify-center items-center flex-col gap-[15px] overflow-hidden'>
        <CgMenuRight className='text-white absolute top-[20px] right-[20px] w-[25px] h-[25px]' onClick={()=>setHam(true)}/>
